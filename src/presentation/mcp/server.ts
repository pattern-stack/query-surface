...
const INSTRUCTIONS = [
  ...
  '  2. select(entity, …)     — find rows at their natural grain (+ semantic rank / relevance).',
  '  3. fetch(entity, ids, …) — hydrate specific IDs into full rows.',
  '  4. measure(entity, …)    — collapse to grouped measures (grain-safe; conformed dimensions only).',
